...
<template>
  <div class="card-container card-medium">
    ...
    <form autocomplete="off">
      ...
      <input
        type="text"
        id="cust-pay-info-card-bank-name"
      ...
      <input
        type="text"
        id="cust-pay-info-card-bank-acc-no"
      ...
      <input
        type="text"
        id="cust-pay-info-card-bank-sort-code"
      ...
      <input
        type="text"
        id="cust-pay-info-card-direct-debit"
